                            ...
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  placeholder="Repite la contraseña..." id="password-confirm" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" required  />
                                    </div>
                                </div>
